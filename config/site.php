...
return [
    ...
    */
    ...
    'description' => 'Laravel — это современный фреймворк для разработки надежных и масштабируемых веб-приложений на PHP с минимальными усилиями. Русскоязычное сообщество и документация.',
