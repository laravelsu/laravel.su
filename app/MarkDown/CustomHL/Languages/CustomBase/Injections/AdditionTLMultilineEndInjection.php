...
#[Before]
final readonly class AdditionTLMultilineEndInjection implements Injection
{
    public function parse(string $content, Highlighter $highlighter): ParsedInjection
    {
        preg_match_all('/(?<match>(.)*\/\/ \[tl\! add\:end\])/', $content, $matches, PREG_OFFSET_CAPTURE);  //  /(?<match>(.)*\/\/ \[tl\! add\])/
